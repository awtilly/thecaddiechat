...
- [ ] **FNDN-01**: Site rebuilt on Astro with reusable component layouts (BaseLayout, PageLayout, CardGrid)
...
- [ ] **FNDN-05**: GitHub Actions CI/CD pipeline deploying to GitHub Pages on push
